...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FairyGUI_UIPackage_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, CreateObject_1);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("GetItemAssetByURL", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetItemAssetByURL_2);
        ...
        static StackObject* CreateObject_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* GetItemAssetByURL_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
